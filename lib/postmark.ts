...
export const sendLogPdfEmail = async (
  ...
  const subject = `TankLog Report - ${logData.site} - ${new Date(logData.occurred_at).toLocaleDateString()}`;
  ...
  const htmlBody = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <p>Please find attached your TankLog report for:</p>
      ...
      <p>This report has been generated by TankLog and is attached to this email.</p>
