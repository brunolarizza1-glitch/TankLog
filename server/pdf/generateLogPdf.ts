...
<body>
    <div class="page">
        ...
        <div class="content">
            ...
            <div class="signature-section">
                ...
                <div class="signature-box">
                    ${
                      log.signature
                        ? `<div style="padding: 0.1in; font-size: 10px; color: #059669;">✓ Digital signature present</div>`
                        : `<div style="padding: 0.1in; font-size: 10px; color: #6b7280;">Digital signature not provided</div>`
                    }
                </div>
        ...
        <div class="footer">
            ...
            <div>This report certifies compliance with ${log.compliance_mode} standards</div>
